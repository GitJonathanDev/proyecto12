<template>
    <div class="container mx-auto p-6">
      <h1 class="text-center text-2xl font-semibold mb-4">Registrar Tipo de Usuario</h1>
  ...
  export default {
    ...
    methods: {
      ...
      submitForm() {
        if (this.isFormValid) {
          Inertia.post(route('tipoUsuario.store'), { descripcion: this.descripcion })
            .then(response => {
              this.successMessage = 'Tipo de usuario registrado exitosamente.';
              this.descripcion = ''; // Limpiar el campo después de la respuesta exitosa
            })
            .catch(error => {
